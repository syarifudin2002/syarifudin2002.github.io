...
// Mendapatkan NIK_Pimpinan dari parameter URL
if (isset($_GET['NIK_Pimpinan'])) {
    $NIK_Pimpinan = $_GET['NIK_Pimpinan'];

    // Query untuk mengambil data pencairan berdasarkan NIK_Pimpinan
    $query_get_pencairan = "SELECT * FROM pencairank WHERE NIK_Pimpinan = ?";
    ...
    $data = null; // Set $data to null if NIK_Pimpinan is not found in URL
}
...
<body>
        ...
        <tr>
            <td>
                    ...
                    <table>
                        <tr>
                            <td class="label">
                                ...
                                <i>
                                    <div style="font-size: 12px;">Paid to</div>
                                </i>
                            </td>
                            <td class="value">
                                <div class="line"><?php echo isset($data['Nama_Pimpinan']) ? htmlspecialchars($data['Nama_Pimpinan']) : 'N/A'; ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                        ...
                        <tr>
                            <td class="label">
                                ...
                                <i>
                                    <div style="font-size: 12px;">Payment for</div>
                                </i>
                            </td>
                            <td class="value">
                ...
                <div class="kwitansi-footer">
                    ...
                    <div class="center">
                        <p><?php echo isset($data['Nama_Pimpinan']) ? htmlspecialchars($data['Nama_Pimpinan']) : 'N/A'; ?></p>
    ...
    <script>
        ...
        function printPage(nikpimpinan) {
            var printWindow = window.open('cetak2.php?NIK_Pimpinan=' + encodeURIComponent(nikpimpinan), '_blank');
