...
foreach ($tables as $table) {
    ...
    if ($last_reg_result && $last_reg_result->num_rows > 0) {
        ...
        $last_reg_num_table = (int)$row['Nomor_Registrasi'];
...
$new_reg_num_formatted = sprintf('%03d', $new_reg_num);
$conn->close();
...
<form action="databases.php" method="post">
    <div style="text-align: center;">
        ...
        <h1 class="mt-4">PENDAFTARAN PROGRAM PERORANGAN</h1>
    </div>
    ...
    <div class="form-container">
        ...
        <div class="form-column">
            ...
            <div class="form-group">
                <label for="jenispembagian">Jenis Penerima</label>
                <select name="jenispembagian" id="jenispembagian" onchange="jenisPembagianChanged()">
                    <option value="muallaf">MUALLAF</option>
                    <option value="mahasiswa_luar_negeri">MAHASISWA LUAR NEGERI</option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nomorktp" id="nomorktp" autocomplete="off" minlength="16" maxlength="16" pattern="\d{16}" required oninput="validateKTP(this)">
                <span id="ktpError" class="error"></span>
            </div>
            <div class="form-group">
                <label for="tempatlahir">Tempat Lahir</label>
                <input type="text" name="tempatlahir" id="tempatlahir" autocomplete="off" oninput="validateInput(this)" required>
            </div>
            <div class="form-group">
                <label for="tanggallahir">Tanggal Lahir</label>
                <input type="date" name="tanggallahir" id="tanggallahir" autocomplete="off" oninput="validateInput(this)" required>
            </div>
        </div>
        ...
        <div class="form-column">
            ...
            <div class="form-group">
                ...
                <input type="text" name="pekerjaan" id="pekerjaan" autocomplete="off" oninput="validateInput(this)" required>
            </div>
            <div class="form-group">
