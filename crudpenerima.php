            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($data_penerima['Jenis_Pembagian']); ?></td>
                    </tr>
                    <tr>
                        <th>Nama</th>
                        <td><?php echo htmlspecialchars($data_penerima['Nama']); ?></td>
                    </tr>
                    <tr>
                        <th>Nomor KTP</th>
                        <td><?php echo htmlspecialchars($data_penerima['Nomor_KTP']); ?></td>
                    </tr>
                    <tr>
                        <th>Tempat Lahir</th>
                        <td><?php echo htmlspecialchars($data_penerima['Tempat_Lahir']); ?></td>
                    </tr>
                    <tr>
                        <th>Tanggal Lahir</th>
                        <td><?php echo htmlspecialchars($data_penerima['Tanggal_Lahir']); ?></td>
                    </tr>
                    <tr>
                        <th>Jenis Kelamin</th>
                        <td><?php echo htmlspecialchars($data_penerima['Jenis_Kelamin']); ?></td>
                    </tr>
                    <tr>
                        <th>Pekerjaan</th>
                        <td><?php echo htmlspecialchars($data_penerima['Pekerjaan']); ?></td>
                    </tr>
                    <tr>
                        <th>Alamat</th>
